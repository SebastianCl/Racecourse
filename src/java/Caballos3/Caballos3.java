...
@WebServlet(name = "Caballos3", urlPatterns = {"/Caballos3"})
public class Caballos3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{           
            ...
            double a1 = Double.parseDouble(request.getParameter("txtApuesta"));
            double m1 = Double.parseDouble(request.getParameter("txtSaldo"));
            
            String nom2 = request.getParameter("txtNombre2");
            int    Cab2 = Integer.parseInt(request.getParameter("cmbCaballo2"));
            double a2 = Double.parseDouble(request.getParameter("txtApuesta2"));
            double m2 = Double.parseDouble(request.getParameter("txtSaldo2"));
            
            String nom3 = request.getParameter("txtNombre3");
            int    Cab3 = Integer.parseInt(request.getParameter("cmbCaballo3"));
            double a3 = Double.parseDouble(request.getParameter("txtApuesta3"));
            double m3 = Double.parseDouble(request.getParameter("txtSaldo3"));
            ...
            if (m.validar() == true) {
                ...
                out.println("<br>");
                out.println("<br>");
                out.println("<h1>Caballo ganador: " + m.getNumG() + "</h1>");
